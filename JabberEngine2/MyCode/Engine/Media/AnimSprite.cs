...
namespace Jabber.Media
{
    public class AnimSprite : Sprite
    {
        ...
        static Dictionary<string, Dictionary<string, AnimaionSet>> loadedAnims = new Dictionary<string, Dictionary<string, AnimaionSet>>();
        ...
        public string Animation
        {
            ...
            set
            {
                if (currentAnimation != value && value != "")
                {
                    m_Animations[value].curFrame = 0;
                    CurrentFrame = m_Animations[value].FrameName;
                }
        ...
        public AnimaionSet CurrentAnim
        {
            get
            {
                return m_Animations[currentAnimation];
            }
        }

        protected Dictionary<string, AnimaionSet> m_Animations = new Dictionary<string, AnimaionSet>();
